...
class Gallery extends Component {
  ...
  displayBigImage = (imageUrl, imageAltText) => {
    ...
    this.setState({imageUrl: image, imageAltText: altText})
  }
    ...
    return (
      <div className="bg-container">
        ...
        <div className="content-container">
          ...
          <p>Nature Photography by Vipin Ptael</p>
        </div>
        <ul className="list-cont">
          {imagesList.map(eachImageItem => (
            <Thumbnail
              eachImageItem={eachImageItem}
              key={eachImageItem.id}
              displayBigImage={this.displayBigImage}
            />
          ))}
        </ul>
      </div>
